...
import static com.atcode.dentgram.helpers.prefs.PrefKeys.App_DENTGRAM;
...
public class PrefUtils {
    ...
    public static void saveOpenStatus(boolean indexlang, Context context) {
        SharedPreferences.Editor editor = context.getSharedPreferences(App_DENTGRAM, Context.MODE_PRIVATE).edit();
    ...
    public static boolean getOpenStatus(Context context) {
        String lang = "";
        boolean status = context.getSharedPreferences(App_DENTGRAM, Context.MODE_PRIVATE).getBoolean(Is_First_open, false);
        if (!status) {
            return true;
        }else {
    ...
    public static void saveUserinformation(Context context, LoginData consumerResponse, int status ) {
        SharedPreferences sharedpreferences = context.getSharedPreferences(App_DENTGRAM, Context.MODE_PRIVATE);
