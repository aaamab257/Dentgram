package com.atcode.dentgram.utils.dialogs;
...
//    }
    ...
    public void showDialogSingleChooice(final Context context,String title, @StringRes int okButtonText, final List<String> listarray, final String arrayType) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
